...
How to use
----------
* Prepare the OTA xml file. Use this [template](https://raw.githubusercontent.com/SlimSaber/packages_apps_AimOTA/lp5.0/examples/ota_lollipop.xml).
* Upload it to your file hosting and create a hot link of it
* Copy the [ota_conf template](https://raw.githubusercontent.com/SlimSaber/packages_apps_AimOTA/lp5.0/examples/ota_conf) to app/src/main/assets folder
...
* Define how AimOTA should know about the "version". The version must be parseable to a date.
  * Usually, the version is a part of a build name. For example, the 20150426 in the SlimSaber-bacon-5.0.2-20150426.
* Adjust the OTA configuration according to your build name on how should AimOTA parse the version
...
* Find a key in build.prop that represents your device name and set it in the "device_name"
  * AimOTA will search this device name in the OTA xml file
...
<img alt="Screenshot"
   ...
   src="https://raw.githubusercontent.com/SlimSaber/packages_apps_AimOTA/lp5.0/screenshots/Screenshot_20150505_1317.png" />
