...
package com.anand.aimota.tasks;
...
import com.anand.aimota.MainActivity;
import com.anand.aimota.R;
import com.anand.aimota.configs.AppConfig;
import com.anand.aimota.configs.LinkConfig;
import com.anand.aimota.configs.OTAConfig;
import com.anand.aimota.configs.OTAVersion;
import com.anand.aimota.dialogs.WaitDialogHandler;
import com.anand.aimota.utils.OTAUtils;
import com.anand.aimota.xml.OTADevice;
import com.anand.aimota.xml.OTAParser;
...
public class CheckUpdateTask extends AsyncTask<Context, Void, OTADevice> {
    ...
    private void showNotification(Context context) {
        ...
        builder.setSmallIcon(R.drawable.ic_notification_aimota);
        builder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_aimota));
